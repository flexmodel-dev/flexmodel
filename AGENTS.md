...
- **[flexmodel-server](./flexmodel-server/AGENTS.md)**: 基于 Quarkus 的服务端实现。采用特性垂直分包架构，提供 REST/GraphQL API、AI 聊天及任务调度。
...
- **特性垂直分包 (Feature-Based Packaging)**: 服务端按业务特性垂直分包，每个特性包内聚 Resource、Service、Repository、DTO。
