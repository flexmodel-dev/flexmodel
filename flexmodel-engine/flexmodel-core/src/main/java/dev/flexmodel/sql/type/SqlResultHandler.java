...
public class SqlResultHandler<T> {
  ...
  private final Map<String, dev.flexmodel.model.field.Field> fmTypeFieldMap = new HashMap<>();
  ...
  public void addSqlTypeHandler(String columnName, SqlTypeHandler<?> typeHandler, @Nullable dev.flexmodel.model.field.Field field) {
  ...
  public dev.flexmodel.model.field.Field getFmTypeField(String columnName) {
