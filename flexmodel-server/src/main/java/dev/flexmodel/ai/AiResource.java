...
import dev.flexmodel.ai.llm.FlexmodelChatService;
import dev.flexmodel.common.config.web.response.ChatChoiceDelta;
import dev.flexmodel.common.config.web.response.ChatDelta;
import dev.flexmodel.common.config.web.response.ChatResponseDelta;
...
public class AiResource {
  ...
  public AiChatConversation getConversation(@PathParam("id") String id) {
    return aiService.getConversationById(id);
  }
  ...
  public Response sendMessage(SendMessageRequest request, @Context SseEventSink eventSink) {
    ...
    String conversationId = StringUtils.isBlank(request.conversationId) ?
      aiService.createConversation(request.content).getId() : request.conversationId;
    AiChatMessage userMsg = new AiChatMessage();
    userMsg.setRole("user");
    userMsg.setContent(request.content);
    userMsg.setConversationId(conversationId);
    userMsg.setProjectId(projectId);
    aiService.saveMessage(userMsg);
