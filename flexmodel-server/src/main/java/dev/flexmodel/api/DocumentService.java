  ...
  private Map<String, Object> buildSchemas(List<ApiDefinition> apis) {
    ...
    for (ApiDefinition api : apis) {
      try {
        ...
        ApiDefinitionMeta meta = JsonUtils.getInstance().convertValue(api.getMeta(), ApiDefinitionMeta.class);
        if (meta == null) {
          continue;
        }
  ...
  public Map<String, Object> buildPaths(List<ApiDefinition> apis) {
    ...
    for (ApiDefinition api : apis) {
      try {
        ...
        ApiDefinitionMeta meta = JsonUtils.getInstance().convertValue(metaMap, ApiDefinitionMeta.class);
