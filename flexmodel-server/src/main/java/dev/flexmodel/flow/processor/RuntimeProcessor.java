...
import dev.flexmodel.flow.dto.bo.FlowInfo;
import dev.flexmodel.flow.dto.bo.FlowInstanceBO;
...
import dev.flexmodel.flow.service.InstanceDataService;
import dev.flexmodel.flow.service.NodeInstanceService;
...
public class RuntimeProcessor {
  ...
  public NodeInstanceListResult getHistoryUserTaskList(String projectId, String flowInstanceId, boolean effectiveForSubFlowInstance) {
    ...
    try {
      ...
      List<dev.flexmodel.flow.dto.bo.NodeInstance> userTaskList = historyListResult.getNodeInstanceList();
